...
#key
set_location_assignment PIN_88 -to key2
set_location_assignment PIN_89 -to key3
set_location_assignment PIN_90 -to key4
set_location_assignment PIN_91 -to key5
set_location_assignment PIN_72 -to key1
